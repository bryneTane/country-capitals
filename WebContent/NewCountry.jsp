...
<html>
	...
	<body class="container">
		<div class="card">
		  <div class="card-header bg-primary text-white"><h3>Country Capitals - Add Country</h3></div>
		  <div class="card-body">
			<form method="post" action="AddCountry">
			  <div class="form-group">
			    <label for="name">The country name</label>
			    <input type="text" class="form-control" name="name" id="name" placeholder="Enter the country name">
			  </div>
			  <div class="form-group">
			    <label for="code">The country code</label>
			    <input type="text" class="form-control" name="code" id="code" placeholder="Enter the country code">
			  </div>
			  <div class="form-group">
			    <label for="capital">Password</label>
			    <input type="capital" class="form-control" name="capital" id="capital" placeholder="Enter the country capital">
			  </div>
